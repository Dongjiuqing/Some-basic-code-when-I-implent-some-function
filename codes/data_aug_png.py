...
if __name__ == "__main__":
    # 原始的img与xml文件路径
    IMG_DIR = "/Users/Dong/Desktop/test/dataset_org/train_png"
    XML_DIR = "/Users/Dong/Desktop/test/dataset_org/train_png_xml"
    # 存储增强后的XML文件夹路径
    AUG_XML_DIR = "/Users/Dong/Desktop/test/dataset_aug/train_png_xml"
    try:
    ...
    mkdir(AUG_XML_DIR)
    # 存储增强后的影像文件夹路径
    AUG_IMG_DIR = "/Users/Dong/Desktop/test/dataset_aug/train_png"
    try:
    ...
    for root, sub_folders, files in os.walk(XML_DIR):
        for name in files:
            ...
            for epoch in range(AUGLOOP):
                ...
                path = os.path.join(AUG_IMG_DIR, str(name[:-4]) + str(epoch) + '.png')
                ...
                print(str(name[:-4]) + str(epoch) + '.png')
                new_bndbox_list = []
